...
//		Private m_Owner = reader.ReadMobile();

///////////////////This number is the value selected skills are
///////////////////set to.

		private double val = 75;
...
///////////////////////////////////////////////////////////////////////
			...
			: base( 0, 0 )
		{
			...
			this.AddPage(6);
			this.AddCheck(55, 65, 210, 211, false, 8);
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				...
				case 1:
				{
					...
					{
						m.SendGump( new SkillPickGump() );
						m.SendMessage( 0, "Please get rid of {0} skills, you have exceeded 1.", info.Switches.Length - switches);
						break;
					}
					else
					{
	...
	{ 
		...
		{	
			...
			m.SendMessage( "Please select one skill to raise to 75." );			
