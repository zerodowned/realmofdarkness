...
namespace Server.Mobiles
{
	...
	public class WarMonger : BaseCreature
	{
		private Ares owner;
		[Constructable]
		public WarMonger ( Ares own ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			owner = own;
			Name = "a war monger";
			Body = 400;
			...
			sword.Hue = 32;
			PlateGorget gorg = new PlateGorget();
			gorg.Hue = 32;
			AddItem( gorg );
			AddItem( sword );
			...
			SetSkill( SkillName.Swords, 50.1, 70.0 );
		...
		public WarMonger( Serial serial ) : base( serial )
		{
		}
