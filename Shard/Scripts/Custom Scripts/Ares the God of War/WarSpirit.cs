...
namespace Server.Mobiles
{
	...
	public class WarSpirit : BaseCreature
	{
		private Ares owner;
		[Constructable]
		public WarSpirit ( Ares own ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			owner = own;
			Name = "a war spirit";
			Body = 26;
		...
		public WarSpirit( Serial serial ) : base( serial )
		{
		}
