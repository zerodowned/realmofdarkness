...
namespace Server.Voting
{
	public static class VoteCommand
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register("VoteConfig", AccessLevel.GameMaster, new CommandEventHandler(VoteConfig_OnCommand));
			CommandSystem.Register("VoteInstance", AccessLevel.GameMaster, new CommandEventHandler(VoteInstance_OnCommand));
		}
