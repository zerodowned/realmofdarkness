...
namespace Server.Mobiles
{
	...
	public class PaintBallBot3 : BaseCreature
	{
		[Constructable]
		public PaintBallBot3() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.1, 0.2 )
		{
			Name = "Paint Ball Bot";
			Body = 401;
			Hue = 33770;
			...
			AddItem( new PaintBallGunBotSlow() );
		...
		public PaintBallBot3( Serial serial ) : base( serial )
		{
		}
