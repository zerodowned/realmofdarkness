...
namespace Server.Mobiles
{
	...
	public class PaintBallBot1 : BaseCreature
	{
		[Constructable]
		public PaintBallBot1() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.1, 0.2 )
		{
			Name = "Paint Ball Bot";
			Body = 401;
			Hue = 33770;
		...
		public PaintBallBot1( Serial serial ) : base( serial )
		{
		}
