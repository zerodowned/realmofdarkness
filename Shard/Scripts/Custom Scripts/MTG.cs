...
namespace Server.Items 
{
	...
	public class TarotDeck1 : Item
	{
		...
		[Constructable]
		public TarotDeck1() : base( 0x12AB )
		{
			Name = "Magic the Gathering deck";
		}
		
		public TarotDeck1( Serial serial ) : base( serial ) 
		{ 
		}
	...
	[Flipable( 0x12AB, 0x12AC )]
	public class DecoTarotDeck1 : Item
	{
		[Constructable]
		public DecoTarotDeck1() : base( 0x12AB )
		{
			Name = "tarot deck";
		}
		
		public DecoTarotDeck1( Serial serial ) : base( serial ) 
		{ 
		}
